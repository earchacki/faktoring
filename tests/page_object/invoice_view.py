...
create_correction_button = '/html/body/app-root/app-layout/main/div/app-invoice-details/div/div[1]/div/div/div[1]/div'
invoice_is_SP = '/html/body/app-root/app-layout/main/div/app-invoice-details/div/div[1]/div/div/section[1]/ul/li'
invoice_number = '/html/body/app-root/app-layout/main/div/app-invoice-details/div/div[1]/div/div/section[1]/div'
invoice_gross_amount = '/html/body/app-root/app-layout/main/div/app-invoice-details/div/div[1]/div/div/section[2]/div[2]/div[2]/div[1]/ul/li[1]/span'
invoice_net_amount = '/html/body/app-root/app-layout/main/div/app-invoice-details/div/div[1]/div/div/section[2]/div[2]/div[2]/div[1]/ul/li[2]/span'
invoice_vat_amount = '/html/body/app-root/app-layout/main/div/app-invoice-details/div/div[1]/div/div/section[2]/div[2]/div[2]/div[1]/ul/li[3]/span'


def wait_for_invoice_view(driver_instance):
    elem = wait_for_visibility_of_element(driver_instance, By.XPATH, create_correction_button)
